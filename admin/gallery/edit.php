        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Form Edit Gallery</h4>
                <?php
                    include '../config.php';
                    $id_gallery = $_GET['id_gallery'];
                    $data = mysqli_query($koneksi,"select * from gallery where id_gallery='$id_gallery'");
              ...
              <form class="form-horizontal style-form" method="post" action="edit_query.php" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo $d['id_gallery']; ?>">
                    <input type="text" class="form-control" name="title" value="<?php echo $d['title_gallery']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Description</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="description" value="<?php echo $d['description_gallery']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Date</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control tanggal" name="date" value="<?php echo $d['tanggal_gallery']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <span class="help-block">Previous image is "<?php echo $d['file_gallery']; ?>".</span>
                  </div>
                </div>
                <div class="form-group">

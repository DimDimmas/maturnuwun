            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="add_query.php" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="proname" placeholder="Input project name">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Title (overlay)</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="titleovr" placeholder="Optional">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Image 1 (building)</label>
                  <div class="col-sm-10">
                    <input type="file" class="form-control" name="building" required>
                  </div>
                </div>
                <div class="form-group">

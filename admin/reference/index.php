  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Reference</h3>
        <hr>
        <?php
          include '../config.php';
        ?>
        <div class="row">
          <div class="col-lg-11 main-chart">            
            <div class="row mt">
                <a class="btn btn-primary add" href="add.php">Add Reference &nbsp; <i class="fa fa-plus" aria-hidden="true"></i></a>
                    ...
                    <?php 
                      ...
                      $no = $limit_start + 1;
                        ...
                        if(isset($_GET['search'])){
                          $search = $_GET['search'];
                          $data = mysqli_query($koneksi,"select * from reference where name_reference like '%".$search."%' order by id_reference desc limit ".$limit_start.",".$limit);				
                        }else{
                          $data = mysqli_query($koneksi,"select * from reference order by id_reference desc limit ".$limit_start.",".$limit);
                        }
                          while($d = mysqli_fetch_array($data)){
                    ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td style="text-transform: capitalize;"><?php echo $d['name_reference']; ?></td>
                            <td style="text-transform: capitalize;"><?php echo $d['title_reference']; ?></td>
                            <td class="center"><img src="../img/reference/<?php echo $d['gedung_reference']; ?>" alt="Image"></td>
                            <td class="center"><img src="../img/reference/<?php echo $d['logo_reference']; ?>" alt="Image"></td>
                            <td class="center"><a href="edit.php?id_reference=<?php echo $d['id_reference']; ?>" class="btn btn-warning">Edit &nbsp; <i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                            <td class="center"><a href="delete.php?id_reference=<?php echo $d['id_reference']; ?>" class="btn btn-danger">Delete &nbsp; <i class="fa fa-times" aria-hidden="true"></i></a></td>
                        </tr>
                    <?php
                        $no++; 
                        }

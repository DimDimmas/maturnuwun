  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Add Username & Password</h3>
        <hr>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Form Add Add Username & Password</h4>
              <form class="form-horizontal style-form" method="post" action="add_query.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-1 col-sm-1 control-label">
                      <a href="../username" class="btn btn-danger">Cancel</a>
                  </label>
                  <label class="col-sm-1 col-sm-1 control-label">

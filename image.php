...
<body id="home">
    ...
    <div class="news-wrapper" id="news">  
      ...
      <?php 
        ...
        $sql = $pdo->prepare("SELECT * FROM gallery WHERE format = 'Image' order by id_gallery desc LIMIT ".$limit_start.",".$limit);
        $sql->execute(); // Eksekusi querynya
        while($d = $sql->fetch()){
        ?>   
        <div class="gallery-item wow animate__animated animate__fadeInUp">          
            <img class="gallery-image" src="admin/img/gallery/<?php echo $d['file_gallery']; ?>" alt="Image">
        </div>
        <?php
          }
        ?>
      ...
      <ul class="pagination justify-content-center">
          ...
          ?>
            <li class="page-item"><a class='page-link' href="image.php?page=1">First</a></li>
            <li class="page-item"><a class='page-link' href="image.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
          <?php
          }
          ?>
          ...
          $sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM gallery  WHERE format = 'Image'");
          ...
          ?>
            <li class="page-item <?php echo $link_active; ?>"><a class='page-link' href="image.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
          <?php
          }
          ?>
          ...
          ?>
            <li class="page-item"><a class='page-link' href="image.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
            <li class="page-item"><a class='page-link' href="image.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
          <?php
          }
          ?>
        </ul>
